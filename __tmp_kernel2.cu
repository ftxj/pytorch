...
__global__ void kernel2(Tensor<float, 2> T0, Tensor<int64_t, 2> T1, Tensor<int64_t, 2> T2, Tensor<float, 2> T3, Tensor<float, 2> T5) {
  NVFUSER_DEFINE_MAGIC_ZERO
  int64_t T4[288];
  #pragma unroll
  for(nvfuser_index_t i19 = 0; i19 < 18; ++i19) {
    int i39;
    i39 = T1.stride[0] * i19;
    int i51;
    i51 = T2.stride[0] * i19;
    ...
    i81 = T3.stride[0] * i19;
    bool b99;
    b99 = (i19 + nvfuser_zero) < 18;
    #pragma unroll
    for(nvfuser_index_t i20 = 0; i20 < 16; ++i20) {
      int i29;
      i29 = i20 + nvfuser_zero;
      int i62;
      i62 = i61 + i20;
      if ((b99 && (i29 < 16))) {
        T4[i62]
          = T1[(i39 + (T1.stride[1] * i29))]
          + T2[(i51 + (T2.stride[1] * i29))];
      }
      T5[(i29 + (28 * T4[i62]))] = T3[(i81 + (T3.stride[1] * i29))];
    }
  }
